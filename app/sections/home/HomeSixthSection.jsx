...
export const HomeSixthSection = () => {
    ...
    const card1X = useTransform(scrollYProgress, [0.1, 0.15], [80, 0]);
    const card1Y = useTransform(scrollYProgress, [0.1, 0.15], [-80, 0]);
    ...
    const card2X = useTransform(scrollYProgress, [0.2, 0.25], [-80, 0]);
    const card2Y = useTransform(scrollYProgress, [0.2, 0.25], [-80, 0]);
    ...
    const card3X = useTransform(scrollYProgress, [0.3, 0.35], [80, 0]);
    const card3Y = useTransform(scrollYProgress, [0.3, 0.35], [-80, 0]);
    ...
    const card4X = useTransform(scrollYProgress, [0.4, 0.45], [-80, 0]);
    const card4Y = useTransform(scrollYProgress, [0.4, 0.45], [-80, 0]);
    ...
    const card5X = useTransform(scrollYProgress, [0.5, 0.55], [80, 0]);
    const card5Y = useTransform(scrollYProgress, [0.5, 0.55], [-80, 0]);
